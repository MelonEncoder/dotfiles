...
Scope {
    ...
    Variants {
        ...
        Item {
            ...
            CornerWindow { modelData: screenGroup.modelData; cornerIndex: 0; topOffset: root.implicitHeight }
            CornerWindow { modelData: screenGroup.modelData; cornerIndex: 1; topOffset: root.implicitHeight }
            CornerWindow { modelData: screenGroup.modelData; cornerIndex: 2 }
            CornerWindow { modelData: screenGroup.modelData; cornerIndex: 3 }
